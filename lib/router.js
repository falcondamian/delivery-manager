...
Router.route('pedidosRepartidor', {
    ...
    waitOn: function() {
        ...
        //TODO Varias rutas en un mismo dia para el repartidor no solo una
        var reparto = repartos.findOne({repartidorId: Meteor.userId(), fecha : today});
        if (reparto) {

            return [Meteor.subscribe('pedidosOfReparto', reparto._id), Meteor.subscribe('clientesOfRuta', reparto.rutaId)];
...
//añadir funcion para admins y controlar acceso a cada pagina
